...
public class DbService {
    ...
    public void instantiateDastaBase() throws Exception {
        ...
        Cliente cli2 = new Cliente(null, "Ana Costa", "lucas_sp100@hotmail.com",
                "65231387045", TipoCliente.PESSOA_FISICA,encoder.encode("123"));
        cli2.getTelefones().addAll(Arrays.asList("9999999","93493956"));
        cli2.addPerfil(Perfil.ADMIN);

        Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
        Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
        Endereco e3 = new Endereco(null, "Avenida Floriano", "2106", "Sala 800", "Centro", "13480520", cli2, c2);
